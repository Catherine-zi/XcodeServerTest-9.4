...
@IBDesignable
@objc open class SWPlaceholderTextView: UITextView {
	...
	@IBInspectable open var placeholderColor: UIColor = SWPlaceholderTextView.Constants.defaultiOSPlaceholderColor {
		didSet {
