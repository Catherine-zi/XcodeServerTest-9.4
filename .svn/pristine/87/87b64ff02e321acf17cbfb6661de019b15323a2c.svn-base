...
- (instancetype)initWithSocksProxyData:(NSData *)socksProxyData
{
    ...
    if (self != nil)
    {
        ...
        _settingsKeychain = [MTFileBasedKeychain keychainWithName:@"Telegram-Settings" documentsPath:[DQDTelegraphManager dqd_documentsPath]];
        ...
        _keychain = [MTFileBasedKeychain keychainWithName:keychainName documentsPath:[DQDTelegraphManager dqd_documentsPath]];
...
- (NSString *)baseUsagePath {
    return [[DQDTelegraphManager dqd_documentsPath] stringByAppendingPathComponent:@"network-usage"];
}
...
- (NSString *)cellularUsageResetPath {
    return [[DQDTelegraphManager dqd_documentsPath] stringByAppendingPathComponent:@"cellular-usage-reset"];
}

- (NSString *)wifiUsageResetPath {
    return [[DQDTelegraphManager dqd_documentsPath] stringByAppendingPathComponent:@"wifi-usage-reset"];
}
