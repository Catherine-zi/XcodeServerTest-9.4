...
- (id)init
{
    ...
    if (self != nil)
    {
        ...
        [TGRemoteImageView registerImageProcessor:^UIImage *(UIImage *source)
        {
            ...
            imageSize = TGFitSizeNew(imageSize, CGSizeMake(200, 200));
        ...
        [TGRemoteImageView registerImageProcessor:^UIImage *(UIImage *source)
        {
            return TGScaleImageToPixelSize(source, TGFitSizeNew(source.pixelSize, CGSizeMake(1024, 1024)));
        } withName:@"maybeScale"];
        ...
        _mediaBox = [[MediaBox alloc] initWithBasePath:[[DQDTelegraphManager dqd_documentsPath] stringByAppendingPathComponent:@"mediacache"]];
    }
    return self;
}
