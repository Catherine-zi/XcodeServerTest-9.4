...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self != nil)
    {
        ...
        {
            CGRect rect = CGRectMake(0, 0, TGClipboardCellCornerRadius * 2 + 1.0f, TGClipboardCellCornerRadius * 2 + 1.0f);
            ...
            cornersImage = [UIGraphicsGetImageFromCurrentImageContext() resizableImageWithCapInsets:UIEdgeInsetsMake(TGClipboardCellCornerRadius, TGClipboardCellCornerRadius, TGClipboardCellCornerRadius, TGClipboardCellCornerRadius)];
