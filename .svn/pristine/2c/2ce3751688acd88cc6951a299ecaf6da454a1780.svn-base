...
- (instancetype)initWithServer:(TGBridgeServer *)server
{
    ...
    if (self != nil)
    {
        ...
        [_disposable setDisposable:[_localizationSignal startWithNext:^(NSNumber *next)
        {
            ...
            {
                NSURL *currentLocalizationUrl = [NSURL fileURLWithPath:[[[DQDTelegraphManager dqd_documentsPath] stringByAppendingPathComponent:@"CustomLocalization.bundle"] stringByAppendingPathComponent:@"Localizable.strings"]];
