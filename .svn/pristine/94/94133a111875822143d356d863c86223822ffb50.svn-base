            ...
            dispatch_async([TGCache diskCacheQueue], ^
                           {
                               ...
                               if (videosPath == nil)
                               {
                                   videosPath = [[DQDTelegraphManager dqd_documentsPath] stringByAppendingPathComponent:@"video"];
                               }
        ...
        dispatch_async([TGCache diskCacheQueue], ^
                       {
                           if (type == TGDocumentFileType || type == TGLocalDocumentFileType)
                           {
                               ...
                               if (filesPath == nil)
                               {
                                   filesPath = [[DQDTelegraphManager dqd_documentsPath] stringByAppendingPathComponent:@"files"];
                               }
                           ...
                           else if (type == TGAudioFileType || type == TGLocalAudioFileType)
                           {
                               ...
                               if (audioPath == nil)
                               {
                                   audioPath = [[DQDTelegraphManager dqd_documentsPath] stringByAppendingPathComponent:@"audio"];
                               }
...
{
    return [DQDTelegraphManager dqd_documentsPath];
}
    ...
    [_backgroundFileIndexingQueue dispatch:^
     {
        ...
        NSString *cachesPath = [TGAppDelegate cachePath];
         ...
         NSString *systemDocumentsDirectory = [DQDTelegraphManager dqd_documentsPath];
