...
@implementation TGMaskStickersSignals
...
+ (void)forceUpdateStickers {
    [[[TGTelegramNetworking instance] genericTasksSignalManager] startStandaloneSignalIfNotRunningForKey:@"forceUpdateMaskStickers" producer:^SSignal *{
        return [[self remoteStickerPacksWithCacheHash:0] onNext:^(NSDictionary *dict) {
            [[[TGTelegramNetworking instance] genericTasksSignalManager] putNext:dict toMulticastedPipeForKey:@"maskStickerPacks"];
        }];
    }];
}

+ (void)dispatchStickers {
    [[[TGTelegramNetworking instance] genericTasksSignalManager] putNext:[self cachedStickerPacks] toMulticastedPipeForKey:@"maskStickerPacks"];
}
...
+ (SSignal *)stickerPacks
{
    return [[SSignal single:nil] mapToSignal:^SSignal *(__unused id defer)
            {
                [[[TGTelegramNetworking instance] genericTasksSignalManager] startStandaloneSignalIfNotRunningForKey:@"updateMaskStickers" producer:^SSignal *
                 {
                ...
                signal = [signal then:[[[TGTelegramNetworking instance] genericTasksSignalManager] multicastedPipeForKey:@"maskStickerPacks"]];
...
+ (NSString *)filePath {
    return [[DQDTelegraphManager dqd_documentsPath] stringByAppendingPathComponent:@"maskStickerPacks.data"];
}
...
{
    TLRPCmessages_getMaskStickers$messages_getMaskStickers *getAllStickers = [[TLRPCmessages_getMaskStickers$messages_getMaskStickers alloc] init];
    ...
    SSignal *archivedStickers = [SSignal single:[NSNull null]];
...
+ (SSignal *)installStickerPackAndGetArchived:(id<TGStickerPackReference>)packReference hintUnarchive:(bool)hintUnarchive
{
    ...
    return [[[TGTelegramNetworking instance] requestSignal:installStickerSet] mapToSignal:^SSignal *(TLmessages_StickerSetInstallResult *result) {
        return [[self stickerPackInfo:packReference] mapToSignal:^SSignal *(TGStickerPack *pack) {
            ...
            [[[TGTelegramNetworking instance] genericTasksSignalManager] putNext:updatedDict toMulticastedPipeForKey:@"maskStickerPacks"];
...
+ (SSignal *)updatedFeaturedStickerPacks {
    return [[[TGTelegramNetworking instance] genericTasksSignalManager] multicastedSignalForKey:@"updateFeaturedMaskStickers" producer:^SSignal *{
...
+ (void)markFeaturedStickersAsRead {
    [[[TGTelegramNetworking instance] genericTasksSignalManager] startStandaloneSignalIfNotRunningForKey:@"markFeaturedMaskStickersAsRead" producer:^SSignal *
     {
