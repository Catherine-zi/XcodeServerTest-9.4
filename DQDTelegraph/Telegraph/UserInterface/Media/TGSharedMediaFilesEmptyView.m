...
@interface TGSharedMediaFilesEmptyView ()
{
...
@implementation TGSharedMediaFilesEmptyView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self != nil)
    {
        _iconView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"SharedMediaEmptyFilesIcon.png"]];
        ...
        _textLabel.text = TGLocalized(@"SharedMedia.EmptyFilesText");
