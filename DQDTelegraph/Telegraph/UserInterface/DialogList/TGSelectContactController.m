...
- (void)actionItemSelected
{
	...
	//qq--add
	[[SPUserEventsManager sharedManager] addCountForEvent:SWUEC_Click_NewGroup_NewMessage_Page];
...
{
	//qq--add
	[[SPUserEventsManager sharedManager] addCountForEvent:SWUEC_Click_NewSecretChat_NewMessage_Page];
...
- (void)loadView
{
	...
	[[SPUserEventsManager sharedManager] addCountForEvent:SWUEC_Enter_NewMessage_Page];
}
