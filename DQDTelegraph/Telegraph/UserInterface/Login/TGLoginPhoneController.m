...
- (id)init
{
    ...
    if (self)
    {
		...
		//qq--add leftBTN
		[self setLeftBarButtonItem:[[UIBarButtonItem alloc] initWithTitle:TGLocalized(@"Common.Back") style:UIBarButtonItemStyleDone target:self action:@selector(diyBackButtonPressed)]];
    }
    return self;
}
- (void)diyBackButtonPressed{
