...
@implementation TLInputPhoneCall$inputPhoneCall : TLInputPhoneCall


- (int32_t)TLconstructorSignature
{
    return (int32_t)0x1e36fded;
}

- (int32_t)TLconstructorName
{
    return (int32_t)0x1f40644d;
}

- (id<TLObject>)TLbuildFromMetaObject:(std::shared_ptr<TLMetaObject>)metaObject
{
    TLInputPhoneCall$inputPhoneCall *object = [[TLInputPhoneCall$inputPhoneCall alloc] init];
