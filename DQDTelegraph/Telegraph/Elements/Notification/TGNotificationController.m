...
//Avazu 20180607 重命名为TGNotificationWindowNew
@interface TGNotificationWindowNew : TGOverlayControllerWindow
...
@interface TGNotificationController () <ASWatcher, TGModernConversationAudioPlayerDelegate>
{
    ...
    TGNotificationWindowNew *_window;
...
- (UIWindow *)notificationWindow
{
    ...
    {
        //Avazu 20180607 注释
        _window = [[TGNotificationWindowNew alloc] initWithFrame:TGAppDelegateInstance.rootController.applicationBounds overInAppBrowser:[TGAppDelegateInstance.rootController.presentedViewController isKindOfClass:[SFSafariViewController class]]];
        _window.tag = 0xbeef;
...
//Avazu 20180607 重命名为TGNotificationWindowNew 
@implementation TGNotificationWindowNew
